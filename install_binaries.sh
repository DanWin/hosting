...
cd ..
cd igbinary && git fetch --all && git checkout 3.2.13 && cd ..
...
# install composer
curl -sSL https://github.com/composer/composer/releases/download/2.5.2/composer.phar > /usr/bin/composer
